-- Catalyst Mom: SEO polish for seeded blog drafts
...
UPDATE public.blogs SET
  ...
  content = '<h2>Can a Birth Ball Really Induce Labor?</h2>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['pregnancy', 'birth ball', 'labor']
WHERE slug = 'birth-ball-to-induce-labor' AND status = 'draft';
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['pregnancy', 'birth ball', 'labor']
WHERE slug = 'peanut-ball-vs-birth-ball' AND status = 'draft';
...
UPDATE public.blogs SET
  ...
  content = '<h2>What Diastasis Recti Actually Is</h2>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['postpartum', 'fitness', 'core']
WHERE slug = 'diastasis-recti-exercises' AND status = 'draft';
...
UPDATE public.blogs SET
  ...
  content = '<h2>The 60-Second Test</h2>
<ol>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['postpartum', 'core']
WHERE slug = 'how-to-check-diastasis-recti-at-home' AND status = 'draft';
...
UPDATE public.blogs SET
  ...
  content = '<h2>Why Some Exercises Make the Gap Worse</h2>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['postpartum', 'fitness', 'core']
WHERE slug = 'exercises-to-avoid-diastasis-recti' AND status = 'draft';
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['postpartum', 'fitness']
WHERE slug = 'c-section-recovery-exercises-week-by-week' AND status = 'draft';
...
UPDATE public.blogs SET
  ...
  content = '<h2>What Your Body Needs Right Now</h2>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['nutrition', 'postpartum']
WHERE slug = 'breastfeeding-meal-plan-7-day' AND status = 'draft';
...
UPDATE public.blogs SET
  ...
  content = '<h2>First, the Honest Truth</h2>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['nutrition', 'postpartum']
WHERE slug = 'foods-to-increase-milk-supply' AND status = 'draft';
...
UPDATE public.blogs SET
  ...
  content = '<h2>The Mindset Shift</h2>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['wellness', 'postpartum']
WHERE slug = 'self-care-ideas-busy-moms' AND status = 'draft';
...
UPDATE public.blogs SET
  ...
  content = '<h2>Why Tracking Changes Everything</h2>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['ttc', 'wellness']
WHERE slug = 'how-to-track-ovulation-ttc' AND status = 'draft';
...
UPDATE public.blogs SET
  ...
  content = '<h2>The 8 Things That Actually Move the Needle</h2>
...
<p><em>This article is for educational purposes only and is not medical advice. Always consult your healthcare provider before starting or changing any exercise, nutrition, or fertility plan.</em></p>',
  tags = ARRAY['ttc', 'wellness', 'nutrition']
WHERE slug = 'how-to-get-pregnant-faster-ttc-tips' AND status = 'draft';
