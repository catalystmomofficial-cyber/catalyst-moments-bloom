...
export const DRAFTS = [
  {
    title: 'How to Use a Birth Ball to Help Induce Labor: What Works and What Is Myth',
    slug: 'birth-ball-to-induce-labor',
    tags: ['pregnancy', 'birth ball', 'labor'],
    featured_image_url: img('photo-1530530824905-661c730c77e0'),
    excerpt: 'Can bouncing on a birth ball really kickstart labor? Here is what the research says, the movements midwives actually recommend, and how to do them safely at home.',
    content: `
...
${DISCLAIMER}`,
  },
  {
    ...
    excerpt: 'They look similar and both live in delivery rooms, but a peanut ball and a birth ball do very different jobs. Here is how to choose — or why you might want both.',
    content: `
...
${DISCLAIMER}`,
  ...
  {
    title: 'Diastasis Recti Exercises: The Safe Way to Rebuild Your Core After Baby',
    slug: 'diastasis-recti-exercises',
    tags: ['postpartum', 'fitness', 'core'],
    featured_image_url: img('photo-1571019613454-1cb2f99b2d8b'),
    excerpt: 'Ab separation does not heal with crunches — it heals with the right deep-core work. These are the evidence-backed exercises that restore strength and close the gap.',
    content: `
...
${DISCLAIMER}`,
  ...
  {
    title: 'How to Check for Diastasis Recti at Home (60-Second Self-Test)',
...
${DISCLAIMER}`,
  ...
  {
    title: '9 Exercises to Avoid With Diastasis Recti (And What to Do Instead)',
    slug: 'exercises-to-avoid-diastasis-recti',
    tags: ['postpartum', 'fitness', 'core'],
    featured_image_url: img('photo-1571190264779-8fed513b7c91'),
    excerpt: 'Some of the most popular ab exercises actively widen ab separation. Here are the nine to skip while you heal — each with a safe swap that trains the same muscles.',
    content: `
...
${DISCLAIMER}`,
  ...
  {
    title: 'C-Section Recovery Exercises Week by Week: A Gentle Return to Strength',
    slug: 'c-section-recovery-exercises-week-by-week',
    tags: ['postpartum', 'fitness'],
    featured_image_url: img('photo-1544367567-0f2fcb009e0b'),
    excerpt: 'A cesarean is major abdominal surgery — your comeback should respect that. This week-by-week movement guide rebuilds your core safely from day one to month three.',
    content: `
...
${DISCLAIMER}`,
  ...
  {
    title: 'The 7-Day Breastfeeding Meal Plan: Eat for Energy, Recovery, and Milk Supply',
...
${DISCLAIMER}`,
  ...
  {
    title: '12 Foods That Support Milk Supply (Backed by Nutrition Science, Not Folklore)',
...
${DISCLAIMER}`,
  ...
  {
    title: 'How to Track Ovulation When TTC: 5 Methods Ranked From Free to High-Tech',
    slug: 'how-to-track-ovulation-ttc',
    tags: ['ttc', 'wellness'],
    featured_image_url: img('photo-1506629905589-5d5b48f62a6a'),
    excerpt: 'Your fertile window is about six days a month - and finding it is the single highest-impact thing you can do while trying to conceive. Here is every tracking method, ranked.',
    content: `
...
${DISCLAIMER}`,
  ...
  {
    title: 'How to Get Pregnant Faster: 8 Evidence-Based TTC Tips (and 3 Myths to Drop)',
