      ...
      <main className="container px-4 mx-auto">
        ...
        <section className="mb-8 max-w-4xl">
          <div className="rounded-lg border border-border bg-muted/40 p-4 text-sm text-muted-foreground flex items-start gap-3">
            ...
            <p>
              <span className="font-medium text-foreground">Before you begin:</span> This program is general education, not medical advice. Check with your provider before starting, and stop and contact them if you feel pain, dizziness, shortness of breath, bleeding, fluid leakage, or contractions.
            </p>
          </div>
        </section>
