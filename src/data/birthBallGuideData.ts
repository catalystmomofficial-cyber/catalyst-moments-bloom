...
export const birthBallExercises: Exercise[] = [
  // Trimester 1 Exercises
  {
    ...
    trimester: 1,
    imageUrl: "/birth-ball-images/pelvic-tilts.png",
    instructions: [
  ...
  },
  {
    ...
    category: "Mobility + Posture",
    trimester: 1,
    imageUrl: "/birth-ball-images/arm-reaches.png",
    instructions: [
  ...
  },
  {
    ...
    category: "Mobility + Posture",
    trimester: 1,
    imageUrl: "/birth-ball-images/deep-breathing.png",
    instructions: [
  ...
  // Trimester 2 Exercises
  {
    ...
    trimester: 2,
    imageUrl: "/birth-ball-images/supported-squats.png",
    instructions: [
  ...
  },
  {
    ...
    category: "Strength + Mobility",
    trimester: 2,
    imageUrl: "/birth-ball-images/side-rocking.png",
    instructions: [
  ...
  // Trimester 3 Exercises
  {
    ...
    category: "Labor Prep",
    trimester: 3,
    imageUrl: "/birth-ball-images/slow-bounces.png",
    instructions: [
  ...
  },
  {
    ...
    category: "Labor Prep",
    trimester: 3,
    imageUrl: "/birth-ball-images/figure-eights.png",
    instructions: [
  ...
  },
  {
    ...
    category: "Labor Prep",
    trimester: 3,
    imageUrl: "/birth-ball-images/all-fours-tilts.png",
    instructions: [
  ...
  },
  {
    ...
    category: "Labor Prep",
    trimester: 3,
    imageUrl: "/birth-ball-images/forward-lean.png",
    instructions: [
...
export const educationalContent = {
  ...
  reducesTearing: {
    title: "Can a Birth Ball Help Reduce Tearing?",
    content: "It can help. Staying upright and mobile on the ball—instead of lying flat—keeps your pelvis open and your perineal muscles flexible, and upright positions are linked with a lower risk of tearing. Here's how these moves support your body:",
    benefits: [
      "Strengthening your pelvic floor to support controlled pushing",
      "Keeping you upright and mobile — positions linked with less tearing than lying on your back",
      "Increasing hip mobility and pelvic flexibility",
      "Teaching breath control and relaxation to help you cope with contractions"
    ],
    note: "Practice consistently from the 3rd trimester—and pair it with perineal massage from around 36 weeks, which research links to noticeably fewer tears—to help your body stay strong, mobile, and ready."
  },
  earlyLabor: {
