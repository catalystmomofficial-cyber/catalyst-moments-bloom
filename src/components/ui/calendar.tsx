  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-xl w-9 font-medium text-[0.7rem] uppercase tracking-wide",
        ...
        day_today: "bg-accent/15 text-accent border border-accent/40 rounded-xl font-semibold",
        day_outside:
