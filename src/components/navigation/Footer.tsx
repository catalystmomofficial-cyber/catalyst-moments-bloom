...
const Footer = () => {
  ...
  return (
    <footer className="safe-area-bottom bg-gradient-to-b from-background to-muted/30 pb-8 pt-12">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <div className="mt-4 flex items-center space-x-3">
              <a
                ...
                className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-input bg-background transition-colors hover:bg-accent hover:text-accent-foreground md:h-9 md:w-9"
              >
