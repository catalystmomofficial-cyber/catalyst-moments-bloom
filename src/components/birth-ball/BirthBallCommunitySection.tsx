      ...
      <CardContent>
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4 max-w-xs">
            Be the first to share your birth ball journey. Share progress, get tips, and connect with other moms.
          </p>
          <Button variant="outline" size="sm" asChild>
            <Link to="/community/birth-ball">Start a Conversation</Link>
          </Button>
        </div>
      </CardContent>
      <CardFooter>
