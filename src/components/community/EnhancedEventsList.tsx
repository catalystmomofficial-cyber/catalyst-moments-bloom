...
const FALLBACK_EVENTS: Event[] = [
  {
    ...
    date: 'Wednesday',
    time: '7:00 PM',
    description: "Whether you're TTC, pregnant, or postpartum — your pelvic floor affects everything. A women's health physio answers the questions your doctor never has time for.",
    attendees: 0,
    type: 'masterclass',
    instructor: 'Guest Expert TBA',
    maxAttendees: 50,
    location: 'virtual',
    featured: true,
    priceNonMember: 2700,
  ...
  },
  {
    ...
    date: 'Thursday',
    time: '8:00 PM',
    description: "Sleep deprivation is not a badge of honour. A sleep specialist breaks down why moms can't sleep and gives you a real protocol to fix it — whatever stage you're in.",
    attendees: 0,
    type: 'qa',
    instructor: 'Guest Expert TBA',
    maxAttendees: 100,
  ...
  },
  {
    ...
    date: 'Tuesday',
    time: '6:00 PM',
    description: 'Understanding your cycle is the most underrated fertility tool you have. An OBGYN answers your specific questions about ovulation, timing, cycle health, and when to seek help.',
    attendees: 0,
    type: 'qa',
    instructor: 'Guest Expert TBA',
    maxAttendees: 40,
  ...
  },
  {
    ...
    date: 'Sunday',
    time: '11:00 AM',
    description: 'Your body already knows how to birth. This hands-on workshop with a certified midwife teaches you the movement, breathing, and positioning techniques that actually prepare you for labour.',
    attendees: 0,
    type: 'workshop',
    instructor: 'Guest Expert TBA',
    maxAttendees: 35,
  ...
  },
  {
    ...
    date: 'Monday',
    time: '7:30 PM',
    description: 'High cortisol blocks fertility, disrupts pregnancy, and stalls postpartum healing. A functional medicine doctor explains the hormonal connection and gives you a simple daily reset protocol.',
    attendees: 0,
    type: 'masterclass',
    instructor: 'Guest Expert TBA',
    maxAttendees: 50,
  ...
  },
  {
    ...
    date: 'Wednesday',
    time: '8:00 PM',
    description: 'Overwhelm, resentment, invisible labour, burnout — this is real and it has a name. A perinatal therapist holds a safe, honest space for the emotional side of motherhood nobody talks about.',
    attendees: 0,
    type: 'qa',
    instructor: 'Guest Expert TBA',
    maxAttendees: 40,
  ...
  },
  {
    ...
    date: 'Saturday',
    time: '12:00 PM',
    description: 'What you eat in the 90 days before conception matters more than most women know. A fertility nutritionist gives you the exact protocol — foods, supplements, what to cut — backed by current research.',
    attendees: 0,
    type: 'workshop',
    instructor: 'Guest Expert TBA',
    maxAttendees: 40,
...
function mapSupabaseEvent(e: SupabaseEvent): Event {
  ...
  return {
    ...
    instructor: e.specialist_name?.trim() || 'Guest Expert TBA',
